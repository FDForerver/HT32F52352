;/****************************************************************************                              */
;/* ht32_op.s: HT32 Series Flash Option Bytes Block                                                         */
;/****************************************************************************                              */
...
;// <i> WDT will be enabled immediately when MCU is power on reset or system reset and can be disabled by firmware. The default timeout period of WDT is 8s.
